...
def build_system_prompt(
    ...
    if "notion" in connected_providers:
        notion_rules = (
            ...
            "  CRITICAL: After notion_query_database returns, you MUST display ALL rows to the user.\n"
            "  The tool result includes a 'formatted_table' field — paste it verbatim in your response.\n"
            "  NEVER show only 1 row or summarize when multiple rows are returned.\n"
